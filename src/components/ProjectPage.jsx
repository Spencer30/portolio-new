      ...
      <div style={styles.sectionContainer}>
        <div style={styles.contentContainer}>
          <div style={styles.textInfoContainer}>
            <h2>Overview</h2>
            <p style={styles.paragraph}>{selectedProject.overview}</p>
          </div>
          <InfoItems
            tech={selectedProject.techStack}
            type={selectedProject.type}
            code={selectedProject.gitHub}
            site={selectedProject.website}
        ...
        <div style={styles.contentContainer}>
          <div style={styles.textInfoContainer}>
            ...
            <p style={styles.paragraph}>{selectedProject.stackReasons}</p>
          </div>
          <div style={styles.textInfoContainer}>
            <h2>Challenges</h2>
